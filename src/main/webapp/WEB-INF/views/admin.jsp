...
<script>
	function catFunction(){
		document.getElementById("catOperate").value="add-category-modal";
		document.getElementById("myForm").submit();
	}
	
	function prodFunction(){
		document.getElementById("catOperate").value="add-product-modal";
		document.getElementById("myForm").submit();
	}
</script>
</head>
<body class="back">
	...
	<form action="productOperation" id="myForm" name="form" method="post" enctype= multipart/form-data >
		<!-- <!-- add category modal -->

		<input type="hidden" name="operate" id="catOperate">
			...
			<div class="modal-dialog modal-lg" role="document">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="container text-center">
							<button type= "button" onclick = "prodFunction()"class=" btn btn-outline-success">Add Product</button>
						</div>
